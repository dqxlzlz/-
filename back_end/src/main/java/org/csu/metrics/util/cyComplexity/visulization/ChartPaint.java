package org.csu.metrics.util.cyComplexity.visulization;
...
//    private static void createChart(Map<String, Integer> data, String name, String index, String root)
//    {
...
//        }
//        JFreeChart jFreeChart = ChartFactory.createBarChart(name, index, "number", dataset, PlotOrientation.VERTICAL, true, true, true);
//        jFreeChart.setTitle(new TextTitle(name, new Font("微软雅黑", Font.BOLD, 20)));
//        CategoryPlot plot = (CategoryPlot)jFreeChart.getPlot();
//        CategoryAxis categoryAxis = plot.getDomainAxis();
//        categoryAxis.setLabelFont(new Font("微软雅黑", Font.BOLD, 10));
//        int cnt = dataset.getColumnCount();
//        try
//        {
//            OutputStream outputStream = new FileOutputStream(root+name+"_"+index+".jpeg");
//            ChartUtils.writeChartAsJPEG(outputStream, jFreeChart, cnt*100, 400);
//            outputStream.close();
//        }catch (Exception e)
//        {
//            e.printStackTrace();
...
//        }
//
//        createChart(wmc, projectName, "wmc", "./");
//        createChart(dit, projectName, "dit", "./");
//        createChart(noc, projectName, "noc", "./");
//        createChart(cbo, projectName, "cbo", "./");
//    }
